...
from trend_radar.utils import check_version_update, get_beijing_time, ensure_directory_exists
from trend_radar.string_process_utils import read_all_today_titles, detect_latest_new_titles, load_frequency_words, save_titles_to_file
from trend_radar.statistic_utils import count_word_frequency
from trend_radar.report_creation import generate_html_report
from trend_radar.message_sender import send_to_notifications
...
class NewsAnalyzer:
    ...
    def __init__(self):
        ...
        self.proxy_url = None
        self._setup_proxy()
        self.data_fetcher = DataFetcher(CONFIG, self.proxy_url)
